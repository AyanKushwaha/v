"""
33.1 - List 12 Performed Activities per Crew Member
"""
...
from salary.Overtime import OvertimeManager as OM
...
class List12(SASReport):
    ...
    def create(self, context=None, reportType='roster'):
        ...
        SASReport.create(self,
                         'List 12 - Performed Activities per Crew Member',
...
def runReport(scope='window'):
    ...
    rptForm = display.reportFormDate('List12', start_date=start_date, end_date=end_date)
    rptForm.show(True)
    if rptForm.loop() == Cfh.CfhOk:
        ...
        Cui.CuiCrgDisplayTypesetReport(Cui.gpc_info, area, scope,
            '../lib/python/report_sources/include/List12.py', 0, args)
