Feature: Check that LPC/OPC documents work.
  ...
  @SCENARIO_A2A5_1 @LPC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that all documents are registered for A2A5 crew

    Given crew member 1 has document "REC+LPCA5" from 1APR2018 to 1APR2020
    ...
    and rave "crg_info.%lpc_str%" shall be " LPC: Sep20 (A2), Mar20 (A5)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A5)"

    @SCENARIO_A2A5_2 @LPC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that LPCA5 document is expired for A2A5 crew

    Given crew member 1 has document "REC+LPCA5" from 1APR2018 to 1FEB2019
    Given crew member 1 has document "REC+OPCA5" from 1MAY2018 to 1MAY2020
    Given crew member 1 has document "REC+LPC" from 1OCT2018 to 1OCT2020 and has qualification "A2"
    Given crew member 1 has document "REC+OPC" from 1NOV2018 to 1NOV2020 and has qualification "A2"
    ...
    and rave "crg_info.%lpc_str%" shall be " LPC: Sep20 (A2), Jan19 (A5)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A5)"


  @SCENARIO_A2A5_3 @LPC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that LPC (A2) document is expired for A2A5 crew
    ...
    and rave "crg_info.%lpc_str%" shall be " LPC: Jan19 (A2), Mar20 (A5)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A5)"

    @SCENARIO_A2A5_4 @LPC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A5_5 @LPC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A5_6 @LPC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PCA5 document is missing for A2A5 crew
    ...
    and the rule "rules_qual_ccr.qln_recurrent_training_performed_all" shall pass on leg 1 on trip 1 on roster 1
    and rave "crg_info.%lpc_str%" shall be " LPC: Sep20 (A2), - (A5)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A5)"


  @SCENARIO_A2A5_7 @LPC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A5_8 @LPC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PC (A2) document is missing for A2A5 crew
    ...
    Then the rule "rules_qual_ccr.qln_all_required_recurrent_dates_registered_all" shall fail on leg 1 on trip 1 on roster 1
    and the rule "rules_qual_ccr.qln_recurrent_training_performed_all" shall pass on leg 1 on trip 1 on roster 1
    and rave "crg_info.%lpc_str%" shall be " LPC: - (A2), Mar20 (A5)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A5)"


  @SCENARIO_A2A5_9 @LPC @OPC @DOCUMENT @RECURRENT
