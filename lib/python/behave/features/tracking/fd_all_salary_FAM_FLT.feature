@tracking @FD @ALL @FAM_FLT
Feature: Salary: Add instructor pay for FAM FLT
##############
## SKCMS-2167
##############

Background:
  Given planning period from 1Aug2019 to 30Aug2019
  Given Tracking

@scenario1
  Scenario: FC crew member has FAM FLT short haul.
   ...
   | type      | leg             | name            | value           |
   | attribute | 2,3             | INSTRUCTOR      | FAM FLT         |
 ...
 @scenario2
  Scenario: FC crew member has FAM FLT long haul.
    ...
    Given trip 1 is assigned to crew member 1 in position FC with
           | type      | leg             | name            | value           |
           | attribute | 1,2,4,5,6,8,9,10 | INSTRUCTOR     | FAM FLT      |
