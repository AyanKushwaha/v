Feature: Check that PC/OPC documents work.
  ...
  @SCENARIO_A2A3_1 @PC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that all documents are registered for A2A3 crew
    ...
    and rave "crg_info.%pc_str%" shall be " PC: Sep20 (A2), Mar20 (A3)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A3)"


  @SCENARIO_A2A3_2 @PC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PCA3 document is expired for A2A3 crew
    ...
    and rave "crg_info.%pc_str%" shall be " PC: Sep20 (A2), Jan19 (A3)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A3)"


  @SCENARIO_A2A3_3 @PC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PC (A2) document is expired for A2A3 crew
    ...
    and rave "crg_info.%pc_str%" shall be " PC: Jan19 (A2), Mar20 (A3)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A3)"


  @SCENARIO_A2A3_4 @PC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A3_5 @PC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A3_6 @PC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PCA3 document is missing for A2A3 crew
    ...
    and the rule "rules_qual_ccr.qln_recurrent_training_performed_all" shall pass on leg 1 on trip 1 on roster 1
    and rave "crg_info.%pc_str%" shall be " PC: Sep20 (A2), - (A3)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A3)"


  @SCENARIO_A2A3_7 @PC @OPC @DOCUMENT @RECURRENT
  ...
  @SCENARIO_A2A3_8 @PC @OPC @DOCUMENT @RECURRENT
  Scenario: Check that PC (A2) document is missing for A2A3 crew
    ...
    Then the rule "rules_qual_ccr.qln_all_required_recurrent_dates_registered_all" shall fail on leg 1 on trip 1 on roster 1
    and the rule "rules_qual_ccr.qln_recurrent_training_performed_all" shall pass on leg 1 on trip 1 on roster 1
    and rave "crg_info.%pc_str%" shall be " PC: - (A2), Mar20 (A3)"
    and rave "crg_info.%opc_str%" shall be "OPC: Oct20 (A2), Apr20 (A3)"


  @SCENARIO_A2A3_9 @PC @OPC @DOCUMENT @RECURRENT
