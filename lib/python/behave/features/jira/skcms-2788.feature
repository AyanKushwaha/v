@JCRT @SVS
Feature: new monthly parttime group in SVS
...
Background:
    ...
    Given a crew member with
           ...
           | region          | SVS        | 05NOV1998  | 31DEC2035 |
  ...
  and the rule "rules_indust_ccr.ind_max_duty_time_in_calendar_month_SVS" shall fail on leg 1 on trip 1 on roster 1
  and the rule "rules_indust_ccr.ind_max_duty_time_in_calendar_month_SVS" shall pass on leg 1 on trip 1 on roster 2


  @SCENARIO_2 @To_Be_Checked
  Scenario: test rule ind_max_duty_time_in_calendar_month_pt_cc_parttime_SVS_monthly_parttime
  ...
  Given trip 7 is assigned to crew member 1
  Given trip 7 is assigned to crew member 2 
  ...
  and the rule "rules_indust_ccr.ind_max_duty_time_in_calendar_month_pt_cc_parttime_SVS_monthly_parttime" shall pass on leg 1 on trip 1 on roster 1
  and the rule "rules_indust_ccr.ind_max_duty_time_in_calendar_month_pt_cc_parttime_SVS_monthly_parttime" shall pass on leg 1 on trip 1 on roster 2
