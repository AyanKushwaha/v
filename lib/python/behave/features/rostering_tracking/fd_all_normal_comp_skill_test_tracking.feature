...
This feature considers tracking system
#############
# SKCMS-1398
#############
...
Background:
  ...
  Given trip 2 is assigned to crew member 1 in position FC with attribute TRAINING="SKILL TEST"
  ...
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 2 on trip 1 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 2
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 2 on trip 1 on roster 2
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 2 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 2 on roster 2
  ...
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 2
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 2 on trip 1 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall fail on leg 2 on trip 1 on roster 2
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 3 on trip 1 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 3 on trip 1 on roster 2
  ##############################################################################
  @CASE_3
  ...
  When I show "crew" in window 1
  Then the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall fail on leg 1 on trip 1 on roster 2
  ##############################################################################
  @CASE_4
  ...
  Given trip 2 is assigned to crew member 3 in position FC with attribute TRAINING="SKILL TEST"
  ...
  Then the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 1
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall fail on leg 1 on trip 1 on roster 2
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 3
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 4
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 5
  and the rule "rules_training_ccr.trng_normal_crew_comp_at_skilltest_cdr_upgrade" shall pass on leg 1 on trip 1 on roster 6
  ##############################################################################
  @CASE_5
