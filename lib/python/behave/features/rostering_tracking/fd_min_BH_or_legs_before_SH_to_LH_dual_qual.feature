@PLANNING @ROSTERING @SKCMS-2326 @TRACKING

Feature: A2 pilot on training to A2A3 need 50 BLH or 20 legs as single qual A3 before regaining A2 qualification.
...
Background: set up for tracking
        ...
        | 1    | CCQ from SH      | ILC        | 01DEC2019  | 02JAN2020  | 1       | 0        | A3     |
    
    Scenario: Insufficient block hours and legs to receive dual qualification

        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | LHR     | 02JAN2020 | 10:00 | 11:00 | SK  | 333    |
        | leg | 0002 | LHR     | OSL     | 02JAN2020 | 12:00 | 13:00 | SK  | 333    |
    ...
    Scenario: Sufficient block hours to receive dual qualification
        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | SFO     | 02JAN2020 | 05:00 | 23:00 | SK  | 333    |
        | leg | 0002 | SFO     | PUS     | 03JAN2020 | 05:00 | 23:00 | SK  | 333    |
        | leg | 0003 | PUS     | OSL     | 04JAN2020 | 05:00 | 23:00 | SK  | 333    |
    ...
    Scenario: Sufficient number of legs to receive dual qualification
        Given a trip with the following activities
        | act | num   | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001  | OSL     | ARL     | 02JAN2020 | 05:00 | 06:00 | SK  | 333    |
        | leg | 0002  | ARL     | OSL     | 02JAN2020 | 06:10 | 07:00 | SK  | 333    |
        | leg | 0003  | OSL     | ARL     | 02JAN2020 | 07:10 | 08:00 | SK  | 333    |
        | leg | 0004  | ARL     | OSL     | 02JAN2020 | 08:10 | 09:00 | SK  | 333    |
        | leg | 0005  | OSL     | ARL     | 02JAN2020 | 09:10 | 10:00 | SK  | 333    |
        | leg | 0006  | ARL     | OSL     | 02JAN2020 | 10:10 | 11:00 | SK  | 333    |
        | leg | 0007  | OSL     | ARL     | 02JAN2020 | 11:10 | 12:00 | SK  | 333    |
        | leg | 0008  | ARL     | OSL     | 02JAN2020 | 12:10 | 13:00 | SK  | 333    |
        | leg | 0009  | OSL     | ARL     | 02JAN2020 | 13:10 | 14:00 | SK  | 333    |
        | leg | 0010  | ARL     | OSL     | 02JAN2020 | 14:10 | 15:00 | SK  | 333    |

        Given a trip with the following activities
        | act | num   | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0011  | OSL     | ARL     | 03JAN2020 | 05:00 | 06:00 | SK  | 333    |
        | leg | 0012  | ARL     | OSL     | 03JAN2020 | 06:10 | 07:00 | SK  | 333    |
        | leg | 0013  | OSL     | ARL     | 03JAN2020 | 07:10 | 08:00 | SK  | 333    |
        | leg | 0014  | ARL     | OSL     | 03JAN2020 | 08:10 | 09:00 | SK  | 333    |
        | leg | 0015  | OSL     | ARL     | 03JAN2020 | 09:10 | 10:00 | SK  | 333    |
        | leg | 0016  | ARL     | OSL     | 03JAN2020 | 10:10 | 11:00 | SK  | 333    |
        | leg | 0017  | OSL     | ARL     | 03JAN2020 | 11:10 | 12:00 | SK  | 333    |
        | leg | 0018  | ARL     | OSL     | 03JAN2020 | 12:10 | 13:00 | SK  | 333    |
        | leg | 0019  | OSL     | ARL     | 03JAN2020 | 13:10 | 14:00 | SK  | 333    |
        | leg | 0020  | ARL     | OSL     | 03JAN2020 | 14:10 | 15:00 | SK  | 333    |
    ...
    Scenario: Sufficient block hours to receive dual qualification from accumulator
        ...
        | name                           | acckey         | tim       | val     |
        | accumulators.block_time_a330   | crew member 1  | 27DEC2019 | 00:00   |
        | accumulators.block_time_a330   | crew member 1  | 30DEC2019 | 50:00   |
    ...
    Scenario: Sufficient number of legs to receive dual qualification from accumulator
        ...
        | name                                         | acckey         | tim       | val  |
        | accumulators.a3_flights_sectors_daily_acc    | crew member 1  | 25DEC2019 | 0    |
        | accumulators.a3_flights_sectors_daily_acc    | crew member 1  | 30DEC2019 | 20   |
    ...
    Scenario: Rule does not apply to flights where the pilot is flying the training AC
        ...
        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | LHR     | 12JAN2020 | 10:00 | 11:00 | SK  | 333    |
        | leg | 0002 | LHR     | OSL     | 12JAN2020 | 12:00 | 13:00 | SK  | 333    |
    ...
    Scenario: Block hours before ILC flight
        ...
        Given table accumulator_rel additionally contains the following
        | name                           | acckey         | tim       | val     |
        | accumulators.block_time_a330   | crew member 1  | 07DEC2019 | 00:00   |
        | accumulators.block_time_a330   | crew member 1  | 10DEC2019 | 50:00   |

        # ILC takes place "here" on 01JAN2020

        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | PUS     | 03JAN2020 | 05:00 | 23:00 | SK  | 333    |
        | leg | 0002 | PUS     | OSL     | 04JAN2020 | 05:00 | 23:00 | SK  | 333    |
