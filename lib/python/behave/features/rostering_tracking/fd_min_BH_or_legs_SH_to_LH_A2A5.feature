...
Feature: A2 pilot on training to A2A5 need 50 BLH or 20 legs as single qual A5 before regaining A2 qualification.
...
Background: set up for tracking
        ...
        | 1    | CCQ from SH      | ILC        | 01DEC2019  | 02JAN2020  | 1       | 0        | A5     |
    
    Scenario: Insufficient block hours and legs to receive dual qualification

        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | LHR     | 02JAN2020 | 10:00 | 11:00 | SK  | 350    |
        | leg | 0002 | LHR     | OSL     | 02JAN2020 | 12:00 | 13:00 | SK  | 350    |
    ...
    Scenario: Sufficient block hours to receive dual qualification from accumulator
        ...
        | name                           | acckey         | tim       | val     |
        | accumulators.block_time_a350   | crew member 1  | 27DEC2019 | 00:00   |
        | accumulators.block_time_a350   | crew member 1  | 30DEC2019 | 50:00   |
    ...
    Scenario: Sufficient number of legs to receive dual qualification from accumulator
        ...
        | name                                         | acckey         | tim       | val  |
        | accumulators.a5_flights_sectors_daily_acc    | crew member 1  | 25DEC2019 | 0    |
        | accumulators.a5_flights_sectors_daily_acc    | crew member 1  | 30DEC2019 | 20   |
    ...
    Scenario: Rule does not apply to flights where the pilot is flying the training AC
        ...
        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | LHR     | 02JAN2020 | 10:00 | 11:00 | SK  | 35A    |
        | leg | 0002 | LHR     | OSL     | 02JAN2020 | 12:00 | 13:00 | SK  | 35A    |
    ...
    Scenario: Block hours before ILC flight
        ...
        Given table accumulator_rel additionally contains the following
        | name                           | acckey         | tim       | val     |
        | accumulators.block_time_a350   | crew member 1  | 07DEC2019 | 00:00   |
        | accumulators.block_time_a350   | crew member 1  | 10DEC2019 | 50:00   |

        # ILC takes place "here" on 01JAN2020

        Given a trip with the following activities
        | act | num  | dep stn | arr stn | date      | dep   | arr   | car | ac_typ |
        | leg | 0001 | OSL     | PUS     | 03JAN2020 | 05:00 | 23:00 | SK  | 35A    |
        | leg | 0002 | PUS     | OSL     | 04JAN2020 | 05:00 | 23:00 | SK  | 35A    |
