...
example usages:
    # in cmsshell
    carmrunner accumulate/scripts/reset_del.py grant
    carmrunner accumulate/scripts/reset_del.py grant --daemon
    carmrunner accumulate/scripts/reset_del.py grant --save --daemon
"""
        return 2
    ...
    if args.grant:
        sh.set_studio_params(
            ...
            "'accumulate.scripts.reset_acc.reset_delgrant;accumulate.scripts.reset_acc.reset_delgrant.main()'")
