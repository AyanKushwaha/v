...
example usages:
    # in cmsshell
    carmrunner accumulate/scripts/reset_upd.py grant
    carmrunner accumulate/scripts/reset_upd.py grant --daemon
    carmrunner accumulate/scripts/reset_upd.py grant --save --daemon
"""
        return 2
    ...
    if args.grant:
        sh.set_studio_params(
            ...
            "'accumulate.scripts.reset_acc.reset_updgrant;accumulate.scripts.reset_acc.reset_updgrant.main()'")
