...
example usages:
    # in cmsshell
    carmrunner accumulate/scripts/reset_ins.py grant
    carmrunner accumulate/scripts/reset_ins.py grant --daemon
    carmrunner accumulate/scripts/reset_ins.py grant --save --daemon
"""
        return 2
    ...
    if args.grant:
        sh.set_studio_params(
            ...
            "'accumulate.scripts.reset_acc.reset_insgrant;accumulate.scripts.reset_acc.reset_insgrant.main()'")
