PAYCODE_FROM_EVENT = {
            ...
            'CNLN_PROD_WEEKEND_DK':   'SAS_DK_CNLN_PROD_WEEKEND',
            'CNLN_PROD_SICK_DK' :   'SAS_DK_CNLN_PROD_SICK',
            'CNLN_PROD_WEEKDAY_NO': 'SAS_NO_CNLN_PROD_WEEKDAY',
            'CNLN_PROD_WEEKEND_NO':   'SAS_NO_CNLN_PROD_WEEKEND',
...
EVENT_FROM_PAYCODE = {
            ...
            'SAS_DK_CNLN_PROD_WEEKEND': 'CNLN_PROD_WEEKEND', 
            'SAS_DK_CNLN_PROD_SICK'         :'CNLN_PROD_SICK',
            'SAS_NO_CNLN_PROD_WEEKDAY'      :'CNLN_PROD_WEEKDAY',
            'SAS_NO_CNLN_PROD_WEEKEND':'CNLN_PROD_WEEKEND',
...
ROSTER_PAYCODES = (
    ...
    'SAS_DK_CNLN_PROD_WEEKEND',
    'SAS_DK_CNLN_PROD_SICK',
    'SAS_NO_CNLN_PROD_WEEKDAY',
    'SAS_NO_CNLN_PROD_WEEKEND',
