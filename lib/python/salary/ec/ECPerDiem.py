"""
Per Diem Evaluation and Ooooooooperrrrrrrrrrrrrationsssssssssssssssssssssss module.
"""
...
TRIP_VALUES = ('report_per_diem.%trip_per_diem_entitled%',
               ...
               'trip.%per_diem_total_at_date%(trip.%end_day%)',
...
LEG_VALUES = ('report_per_diem.%leg_start_station%',
              ...
              'leg.%per_diem_amount_at_date%(trip.%end_day%)',
              ...
              'report_per_diem.%per_diem_compensation_at_date%(trip.%end_day%)',
