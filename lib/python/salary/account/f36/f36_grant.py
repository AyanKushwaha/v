...
def main():
    ...
    crew_list, = R.eval(
        ...
        R.foreach(
            ...
            "crew.%id%",
            "crew.%fullname%",
            "report_account.%%f36_quota_at_date%%(%s)" % jan01,
            "report_account.%%duty_percent_at_date%%(%s)" % jan01,
            "report_account.%%f36_quota_group_desc_at_date%%(%s)" % jan01,
        ))
    ...
    if is_daemon:
        ...
        st.show_file_in_window("F36 grant result", temp_f)
