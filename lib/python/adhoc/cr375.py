...
Add an agreement called 'no_night_upg' valid from 01Jul2009 to the table 
'agreement_validity'
...
validstart = to_dave_date(datetime.datetime(2009, 7, 1))
validto = to_dave_date(datetime.datetime(2035, 12, 31))



agreement_validity = {'id':'no_night_upg',
...
fixit.program = 'cr375.py (%s)' % __version__
