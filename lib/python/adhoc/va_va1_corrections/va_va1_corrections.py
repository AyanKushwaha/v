...
crewList = []
def main():
    create_va_va1_corrections()
    fixit()
 
def create_va_va1_corrections():
    with open('./va_va1_corrections.csv') as csvFile:
...
__version__ = '2021-01-25b'
fixit.program = 'va_va1_corrections.py (%s)' % __version__
