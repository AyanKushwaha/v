...
Usage:
    ...
    4. Run using
        $ python account_entry_CC_DK_corrections.py
'''
...
def create_corrections():
    with open('./account_entry_CC_DK_corrections.csv') as csvFile:
...
fixit.program = 'account_entry_CC_DK_corrections.py (%s)' % __version__
