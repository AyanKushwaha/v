...
Usage:
    ...
    4. Run using
        $ python account_entry_CC_corrections.py
'''
...
def create_corrections():
    with open('./account_entry_CC_corrections.csv') as csvFile:
...
__version__ = '2023-06-02a'
fixit.program = 'account_entry_CC_corrections.py (%s)' % __version__
