"""
Customized parser for exchange rates imported from Tibco
This file builds on the parser used to parse exhange rates from RACER system.
"""
...
class CurrencyParser(MessageHandlerBase):
    """
    The CurrencyParser accepts one or more lines at the time. Each line contains conversion
