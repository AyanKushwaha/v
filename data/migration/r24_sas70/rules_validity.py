...
def fixit(dc, *a, **k):
    ...
    # SKCMS-1796, SKCMS-1837, SKCMS-1838
    set_valid(ops, ag, 'training_rules_oct2018', '01OCT2018', 'Validity parameter for training rules SKCMS-1796, SKCMS-1837, SKCMS-1838')

    # SKCMS-1892
    set_valid(ops, ag, 'salary_skd_cc_rp_home_sb', '01SEP2018', 'Salary: SKD RP to get paid for home SB in same way as SKS RP')

    # SKCMS-1880
    set_valid(ops, ag, 'part_time_crew_less_75_jan2019', '01JAN2019', 'Validity parameter for part time staff rules SKCMS-1880')

    # SKCMS-1897
    set_valid(ops, ag, 'part_time_crew_grtr_80_jan2019', '01JAN2019', 'Validity parameter for part time staff rules SKCMS-1897')


    # SKCMS-1943
    set_valid(ops, ag, 'extra_ci_for_cc_training', '01OCT2018', 'Validity parameter for extra ci/co time for CC SKS rules SKCMS-1943')
