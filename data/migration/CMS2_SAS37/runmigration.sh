#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS 37
#
#
...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS37/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 37 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS37
...
#echo "  * RULES_VALIDITY ..."
python $CARMUSR/data/migration/CMS2_SAS37/rules_validity.py 2>&1 | tee $LOG_DIR/SAS37_VALIDITY.log


echo "  * SKCMS-677 ..."
python $CARMUSR/data/migration/CMS2_SAS37/skcms_677.py 2>&1 | tee $LOG_DIR/SKCMS-677.log

echo "  * SKCMS-1003 ..."
python $CARMUSR/data/migration/CMS2_SAS37/skcms_1003.py 2>&1 | tee $LOG_DIR/SKCMS-1003.log
mv change* $LOG_DIR/
