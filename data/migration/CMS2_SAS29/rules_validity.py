...
def fixit(dc, *a, **k):
    ...
    ag.load(None)
    set_valid(ops, ag, 'oma16_a','1FEB2016','First/main production date for oma16')
    set_valid(ops, ag, 'k15qa_feb16','1FEB2016','Cimber union agreement intended for 1feb2016') 
    set_valid(ops, ag, 'k15sk_jan16','1JAN2016','SAS union agreement intended for 1feb2016') 
    return ops
