#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS 32
#
# Included migrations:
...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS32/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 32 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS32
...
echo "  * SKCMS-565 ..."
python $CARMUSR/data/migration/CMS2_SAS32/skcms_565.py 2>&1 | tee $LOG_DIR/SKCMS-565.log

echo "  * RULES_VALIDITY ..."
python $CARMUSR/data/migration/CMS2_SAS32/rules_validity.py 2>&1 | tee $LOG_DIR/SAS32_VALIDITY.log

echo "  * SKCMS-649 ..."
python $CARMUSR/data/migration/CMS2_SAS32/skcms_649.py 2>&1 | tee $LOG_DIR/SKCMS-649.log

echo "  * SKCMS-649_2 ..."
python $CARMUSR/data/migration/CMS2_SAS32/skcms_649_2.py 2>&1 | tee $LOG_DIR/SKCMS-649_2.log
...
#$CARMUSR/data/migration/CMS2_SAS32/manpower_migration.sh
