...
echo "  * SKCMS-2709: JCRT: Add legality for extra course day on CC recurrent REC"
python $CARMUSR/data/migration/$RELEASE/skcms-2709.py 2>&1 | tee $LOG_DIR/skcms-2709.log
...
echo "  * SKCMS-2707: Importing crc/etable/dave_filter/*.etab into database"
$CARMUSR/bin/admin/setup/setup_filters.sh -c -d | tee -a $LOG_DIR/SKCMS-2707.log

echo "  * SKCMS-2702: Update PC/OPC recurrent filters"
python $CARMUSR/data/migration/$RELEASE/SKCMS-2702.py 2>&1 | tee $LOG_DIR/SKCMS-2702.log
