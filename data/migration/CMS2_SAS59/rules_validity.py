...
def fixit(dc, *a, **k):
    ...
    # SKCMS-1677
    set_valid(ops, ag, 'dk_no_fd_dbl_pdiem_holidays', '01APR2017', 'Double perdiem payment for DK and NO pilots on national holidays')

    # SKCMS-1662
    set_valid(ops, ag, 'k17_skn_fc_jcpr_valid', '01MAR2018', 'Scheduled FDP more then 12h requires extended rest for SKN_FD_AG')
