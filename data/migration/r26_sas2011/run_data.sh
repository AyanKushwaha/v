...
# python $CARMUSR/data/migration/$RELEASE/skcms-1234.py 2>&1 | tee $LOG_DIR/skcms-1234.log
 ...
 echo "  * SKCMS-2514: Add special schedule LimitLHUnbid"
 python $CARMUSR/data/migration/$RELEASE/skcms-2514.py 2>&1 | tee $LOG_DIR/skcms-2514.log

# Uncomment this in case dave filters shall be modified, remember to update JIRA number
#echo "  * SKCMS-2458: Importing crc/etable/dave_filter/*.etab into database"
