#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS 35
#
# Included migrations:
...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS35/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 35 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS35
...
#echo "  * RULES_VALIDITY ..."
#python $CARMUSR/data/migration/CMS2_SAS35/rules_validity.py 2>&1 | tee $LOG_DIR/SAS35_VALIDITY.log
...
#$CARMUSR/data/migration/CMS2_SAS35/manpower_migration.sh
