...
echo "  * SKCMS-2333 A2LR: Add Q2LR activity"
python $CARMUSR/data/migration/$RELEASE/skcms_2333_add_Q2LR_activity.py 2>&1 | tee $LOG_DIR/skcms_2333_add_Q2LR_activity.log
echo "  * SKCMS-2334 A2LR: Add LRP2 activity"
python $CARMUSR/data/migration/$RELEASE/skcms_2334_add_LRP2_activity.py 2>&1 | tee $LOG_DIR/skcms_2334_add_LRP2_activity.log
