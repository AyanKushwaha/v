...
CARMUSR=`pwd`
RELEASE=CMS2_SAS46
LOG_DIR="$CARMUSR/data/migration/$RELEASE/migration_logs_accf_`date +%Y%m%d_%H.%M.%S`"
...
python $CARMUSR/data/migration/$RELEASE/acc_fix.py 2>&1 | tee $LOG_DIR/ACC_FIX.log
