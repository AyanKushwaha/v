...
echo "  * SKCMS-1267 part 1 ..."
python $CARMUSR/data/migration/$RELEASE/skcms_1267_part1.py 2>&1 | tee $LOG_DIR/SKCMS-1267_part1.log

echo "  * SKCMS-1267 part 2 ..."
python $CARMUSR/data/migration/$RELEASE/skcms_1267_part2.py 2>&1 | tee $LOG_DIR/SKCMS-1267_part2.log

echo "  * SKCMS-1267 part 3 ..."
python $CARMUSR/data/migration/$RELEASE/skcms_1267_part3.py 2>&1 | tee $LOG_DIR/SKCMS-1267_part3.log
