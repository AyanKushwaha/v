#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS20
#
# Included migrations:
#
...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS20/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 20 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS20

echo " - Updating schema"
db updateschema 2>&1 | tee $UPDATE_SCHEMA_LOG
# This should add table "flyover" to the DB
