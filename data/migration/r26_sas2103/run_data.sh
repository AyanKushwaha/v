...
python $CARMUSR/data/migration/$RELEASE/skcms-2559.py 2>&1 | tee $LOG_DIR/skcms-2559.log

echo "  * SKCMS-2596: 3 production days 60h rest"
python $CARMUSR/data/migration/$RELEASE/skcms-2596.py 2>&1 | tee $LOG_DIR/skcms-2596.log

echo "  * SKCMS-2597: Some description"
python $CARMUSR/data/migration/$RELEASE/skcms-2597.py 2>&1 | tee $LOG_DIR/skcms-2597.log
...
echo "  * SKCMS-2594: K20 SKN CC Salary"
python $CARMUSR/data/migration/$RELEASE/skcms-2594.py 2>&1 | tee $LOG_DIR/skcms-2594.log
