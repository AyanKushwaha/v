...
def fixit(dc, *a, **k):
    ...
    set_valid(ops, ag, 'new_training_codes_17_CC','01JUL2017','New Training Codes of 2017 CC')
    set_valid(ops, ag, 'new_training_codes_17_FD','01JUL2017','New Training Codes of 2017 FD')

    # SKCMS-1663 and SKCMS-1669
    set_valid(ops, ag, 'k17_skn_fc', '01FEB2018', 'K17 - SKN FD: New weekend definition and a limit for 4P+2F')
