...
echo "  * SKPROJ-53 ..."
python $CARMUSR/data/migration/$RELEASE/update_tables.py 2>&1 | tee $LOG_DIR/SKPROJ53.log
python $CARMUSR/data/migration/$RELEASE/rules_validity.py 2>&1 | tee $LOG_DIR/SKPROJ53.log
