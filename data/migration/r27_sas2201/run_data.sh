...
echo "  * SKCMS-2851 : Updating Web training codes"
python $CARMUSR/data/migration/$RELEASE/skcms-2851.py 2>&1 | tee $LOG_DIR/skcms-2851.log

echo "  * SKCMS-2815:JCRT MFF continuity rules"
python $CARMUSR/data/migration/$RELEASE/skcms-2815.py 2>&1 | tee $LOG_DIR/skcms-2815.log
