...
echo "  * SKCMS-2576 Add new instructor qual SEN-EX."
python $CARMUSR/data/migration/$RELEASE/skcms_2576.py 2>&1 | tee $LOG_DIR/skcms-2576.log

echo "  * SKCMS-2595 Add agreement validity parameter k20_skn_cc_co_on_freeday_comp."
python $CARMUSR/data/migration/$RELEASE/skcms-2595.py 2>&1 | tee $LOG_DIR/skcms-2595.log
