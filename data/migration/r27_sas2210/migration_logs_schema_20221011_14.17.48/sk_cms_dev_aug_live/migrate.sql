...
------ alter_table_bought_days_svs_post_ddl.sql ------
PROMPT Post alter table for bought_days_svs

ALTER TABLE bought_days_svs MODIFY hours NUMBER(10);
ALTER TABLE bought_days_svs MODIFY minutes NUMBER(10);


COMMIT;


------ alter_table_bought_days_svs_tmp_post_ddl.sql ------
PROMPT Post alter table for bought_days_svs_tmp

ALTER TABLE bought_days_svs_tmp MODIFY hours NUMBER(10);
ALTER TABLE bought_days_svs_tmp MODIFY minutes NUMBER(10);
...
------ alter_entity_bought_days_svs_metadata.sql ------
-- Update metadata in dave_entity_attribs
UPDATE dave_entity_attribs
    SET c_attrib_apitype = 'R'
    WHERE c_ent_name = 'bought_days_svs' AND c_attrib_name = 'hours';
UPDATE dave_entity_attribs
    SET c_attrib_apitype = 'R'
    WHERE c_ent_name = 'bought_days_svs' AND c_attrib_name = 'minutes';
