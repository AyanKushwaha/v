...
echo "  * SKCMS-2821: Max time between weekly rest in standby line"
python $CARMUSR/data/migration/$RELEASE/skcms-2821.py 2>&1 | tee $LOG_DIR/skcms-2821.log
echo "  * SKCMS-2751:JCRT: Change name standard for web training in connection with PC/OPC"
python $CARMUSR/data/migration/$RELEASE/skcms-2751.py 2>&1 | tee $LOG_DIR/skcms-2751.log

echo "  * SKPROJ-443: Norway's public holiday compensation for CC"
python $CARMUSR/data/migration/$RELEASE/SKPROJ-443.py 2>&1 | tee $LOG_DIR/SKPROJ-443.log
