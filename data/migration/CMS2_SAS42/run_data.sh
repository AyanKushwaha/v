...
echo "  * SKCMS-1060 ..."
python $CARMUSR/data/migration/CMS2_SAS42/skcms_1060.py 2>&1 | tee $LOG_DIR/SKCMS-1060.log

echo "  * SKCMS-1207 ..."
python $CARMUSR/data/migration/CMS2_SAS42/skcms_1207.py 2>&1 | tee $LOG_DIR/SKCMS-1207.log
