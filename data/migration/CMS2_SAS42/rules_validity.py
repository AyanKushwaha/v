...
def fixit(dc, *a, **k):
    ...
    ag.load(None)
    set_valid(ops, ag, 'cba16_VA_cost','01DEC2016','Applied costs for VA days assigned in (published) roster.')
    set_valid(ops, ag, 'cba16_F0_F36_entitlement','01JAN2017','Regulates F0 and F36 entitlements schemes.')
    set_valid(ops, ag, 'wt_with_PC_17_1','01jan2017','Web training WTxx needed with PC/OPC, phase 1')
