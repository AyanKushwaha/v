...
echo "  * SKCMS-2820: Update Link crew data"
python $CARMUSR/data/migration/$RELEASE/skcms-2820.py 2>&1 | tee $LOG_DIR/skcms-2820.log

echo "  * SKCMS-2773: TE: Overtime pay for Link crew"
python $CARMUSR/data/migration/$RELEASE/skcms-2773.py 2>&1 | tee $LOG_DIR/skcms-2773.log

echo "  * SKCMS-2820_1: Update salary arcticle for link crew"
python $CARMUSR/data/migration/$RELEASE/skcms-2820_1.py 2>&1 | tee $LOG_DIR/skcms-2820_1.log
