...
echo "  * SKCMS-2738: Crew Accounts: Decommission F0 and F36 entitlement calculations and reset values"
python $CARMUSR/data/migration/$RELEASE/skcms-2738.py 2>&1 | tee $LOG_DIR/skcms-2738.log
...
echo "  * SKCMS-2926:Crew meal opt-out info in crew_annotation"
python $CARMUSR/data/migration/$RELEASE/skcms-2926.py 2>&1 | tee $LOG_DIR/skcms-2926.log
