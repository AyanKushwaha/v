...
echo "  * SAS75 ..."
echo "  * Adding validiy parameter for new SKN CC F0 quotas, SKCMS-2025 "
python $CARMUSR/data/migration/$RELEASE/2025_add_agreement_validity.py 2>&1 | tee -a $LOG_DIR/SAS75.log
echo "  * Adding buffer parameter for ensuring max duty hours per calendar year, SKCMS-2013 "
python $CARMUSR/data/migration/$RELEASE/2013_add_property.py 2>&1 | tee -a $LOG_DIR/SAS75.log
