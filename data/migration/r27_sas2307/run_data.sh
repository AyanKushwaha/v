...
echo "  * SKCMS-3372:  MFF: Introduce new training attribute OTS CHANGE"
python $CARMUSR/data/migration/$RELEASE/SKCMS-3372.py 2>&1 | tee $LOG_DIR/SKCMS-3372.log
...
echo "  * SKCMS-3372: MFF: Introduce new training attribute OTS CHANGE"
$CARMUSR/bin/admin/setup/setup_filters.sh -c -d | tee -a $LOG_DIR/SKCMS-3372.log
