...
echo "  * SKCMS-2777: Link Meal cost"
python $CARMUSR/data/migration/$RELEASE/skcms-2777.py 2>&1 | tee $LOG_DIR/skcms-2777.log

echo "  * SKCMS-2807: EC: Senior Cabin Crew (SCC) pay for Link"
python $CARMUSR/data/migration/$RELEASE/skcms-2807.py 2>&1 | tee $LOG_DIR/skcms-2807.log
