...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS17/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 17 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS17
...
#$CARMUSR/data/migration/CMS2_SAS17/manpower_migration.sh
