...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS14/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 14 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS14
...
echo "  * SASCMS-6272 ..."
python $CARMUSR/data/migration/CMS2_SAS14/sascms_6272.py 2>&1 | tee $LOG_DIR/SASCMS-6272.log
...
$CARMUSR/data/migration/CMS2_SAS14/manpower_migration.sh
