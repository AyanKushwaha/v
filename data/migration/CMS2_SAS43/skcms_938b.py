...
def fixit(dc, *a, **k):
    ...
    crt_prop(ops, prop_set_tbl, prop_tbl, 'wt_publish_date','Date in format ddMMM when new webtraing courses are available. Example 15dec','1jan2016','31dec2035',
        None, None, None, '15dec')
...
fixit.program = 'skcms_938b.py (%s)' % __version__
