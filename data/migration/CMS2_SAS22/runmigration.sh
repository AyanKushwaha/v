#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS 22
#
# Included migrations:
#
...
echo "********************************************"
echo "CMS2 SAS 22 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS22
...
echo "  * SKCMS-393 ..."
python $CARMUSR/data/migration/CMS2_SAS22/skcms_393.py 2>&1 | tee $LOG_DIR/SKCMS-393.log
