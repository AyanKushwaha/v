...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS27/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 27 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS27
...
#$CARMUSR/data/migration/CMS2_SAS27/manpower_migration.sh
