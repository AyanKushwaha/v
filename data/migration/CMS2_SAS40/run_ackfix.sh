...
CARMUSR=`pwd`
RELEASE=CMS2_SAS40
LOG_DIR="$CARMUSR/data/migration/$RELEASE/migration_logs_ackf_`date +%Y%m%d_%H.%M.%S`"
...
echo "  * Fix accumulator ..."
python $CARMUSR/data/migration/$RELEASE/ackum_fix.py 2>&1 | tee $LOG_DIR/ACKUM_FIX.log
