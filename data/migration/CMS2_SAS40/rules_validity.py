...
def fixit(dc, *a, **k):
    ...
    ag.load(None)
    set_valid(ops, ag, 'cba16_oct','1OCT2016','New rules for norwegian cabin crew')
    set_valid(ops, ag, 'cba16_nov','1NOV2016','New rules for norwegian cabin crew')
    set_valid(ops, ag, 'cau16_nov','1NOV2016','New rules for danish cabin crew')
