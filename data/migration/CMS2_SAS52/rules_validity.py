...
def fixit(dc, *a, **k):
    ...
    set_valid(ops, ag, 'web_training_pc_SH_17','01AUG2017','Check web training in connection with PC for SH')
    set_valid(ops, ag, 'web_training_pc_LH_17','30DEC2035','Check web training in connection with PC for LH')
