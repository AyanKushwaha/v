#!/bin/sh
echo "************************************************************"
echo "* SASCMS-6137: Inactivate all bids that should no longer be available for crew group FD LH          *"
echo "************************************************************"
echo ""
...
('consecutive_days_off', 'consecutive_days_at_work', 'check_in', 'check_out', 'combination', 'leg_duration', 'string_of_days_off', 'pairing_length'))"`
echo $result
