...
CARMUSR=`pwd`
RELEASE=CMS2_SAS41
LOG_DIR="$CARMUSR/data/migration/$RELEASE/migration_logs_fix_`date +%Y%m%d_%H.%M.%S`"
...
echo "  * SKCMS-1290a ..."
python $CARMUSR/data/migration/$RELEASE/skcms_1290a.py 2>&1 | tee $LOG_DIR/SKCMS-1290a.log
