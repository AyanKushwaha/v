...
echo "  * SKCMS-1134 ..."
python $CARMUSR/data/migration/CMS2_SAS41/skcms_1134.py 2>&1 | tee $LOG_DIR/SKCMS-1134.log

echo "  * SKCMS-1070 ..."
python $CARMUSR/data/migration/CMS2_SAS41/skcms_1070.py 2>&1 | tee $LOG_DIR/SKCMS-1070.log
