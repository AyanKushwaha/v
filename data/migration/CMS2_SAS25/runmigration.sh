#!/bin/sh
#
# This script performs migration related model changes for CMS2 SAS 25
#
# Included migrations:
...
CARMUSR=`pwd`
LOG_DIR="$CARMUSR/data/migration/CMS2_SAS25/migration_logs_`date +%Y%m%d_%H.%M.%S`"
...
echo "********************************************"
echo "CMS2 SAS 25 Database Migration script"
echo "********************************************"
...
cd $CARMUSR/data/migration/CMS2_SAS25
...
echo "  * SKCMS-552 ..."
python $CARMUSR/data/migration/CMS2_SAS25/skcms_552.py 2>&1 | tee $LOG_DIR/SKCMS-552.log


echo "  * SKCMS-410 ..."
python $CARMUSR/data/migration/CMS2_SAS25/skcms_410.py 2>&1 | tee $LOG_DIR/SKCMS-410.log
