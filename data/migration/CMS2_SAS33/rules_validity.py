...
def fixit(dc, *a, **k):
    ...
    ag.load(None)
    set_valid(ops, ag, 'nkf_bl_month','1JAN2016','Blank day per month for NKF CC')
    set_valid(ops, ag, 'k15qa_fdmeal','01JAN2035','Switch off meal rules for QA FD')
