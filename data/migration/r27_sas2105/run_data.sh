...
echo "  * SKCMS-2605: K20 SKN,SKD,SKS CC meal stop"
python $CARMUSR/data/migration/$RELEASE/Skcms-2605.py 2>&1 | tee $LOG_DIR/Skcms-2605.log

echo "  * SKCMS-2615: JCRT: Increase number of allowed CC on A2 NEW flights"
python $CARMUSR/data/migration/$RELEASE/skcms-2615.py 2>&1 | tee $LOG_DIR/skcms-2615.log
