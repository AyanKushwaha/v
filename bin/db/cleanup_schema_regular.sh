...
CLEANUP_XML="${CARMUSR}/etc/programs/dave_cleanup_regular.xml" # change name to whatever
LOGFILE="${CARMTMP}/logfiles/cleanup_schema_regular.$USER.`date '+%Y%m%d.%H%M.%S'`.$HOSTNAME"
