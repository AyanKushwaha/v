 ...
 */
js.ib.widgets.Comment = function(bidModel, bidProperty, config, dataSourceManager) {
    ...
    this.label = new js.ib.ui.CWTextLabel({
        style: 'font-style: italic;',
    	html: js.crewweb.warp.jsbase.util.Localization.translate(config.attributes.text)
    });
    
    return js.ib.widgets.Comment.superclass.constructor.call(this, 1, [
        {
            colspan: 1,
            item: this.label
        }
...
Ext.extend(js.ib.widgets.Comment, js.ib.ui.CWTablePanel, 
{
    focus: function() {
