 ...
 */
js.crewweb.warp.widgets.Comment = function(bidModel, bidProperty, config, dataSourceManager) {
    ...
    return js.crewweb.warp.widgets.Comment.superclass.constructor.call(this, 1, [
        {
            colspan: 1,
            item: this.label
        }
...
Ext.extend(js.crewweb.warp.widgets.Comment, js.crewweb.warp.jsbase.ui.CWTablePanel, 
{
    focus: function() {
