...
public class FOACQualificationParameterHandlerClass implements DataSourceValueSetParametersHandler {


    public FOACQualificationParameterHandlerClass() {
    }

    @Override
    public Map<String, String> getParameters(Map<String, String> requestParams) {
        Map<String, String> result = new HashMap<String, String>();
        result.put(ValueSetParameters.ENTRY_NAME, "foac_qual");
