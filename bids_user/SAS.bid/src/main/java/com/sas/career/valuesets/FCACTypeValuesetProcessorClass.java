...
public class FCACTypeValuesetProcessorClass implements DataSourceProcessorInterface, DataSourceLookupHelperAware {
	
	private DataSourceLookupHelper dataSourceLookupHelper;
	
	private static final String cc_datasource = "valueset.fcac_qual";
	...
	public DataSourceContainer process(DataSourceDescriptor arg0,
		...
		DataSourceContainer dataSource = dataSourceLookupHelper.getDataSource(cc_datasource);
