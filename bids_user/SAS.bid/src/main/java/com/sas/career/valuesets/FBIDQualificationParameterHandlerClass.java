...
public class FBIDQualificationParameterHandlerClass implements DataSourceValueSetParametersHandler {


    public FBIDQualificationParameterHandlerClass() {
    }

    @Override
    public Map<String, String> getParameters(Map<String, String> requestParams) {
        Map<String, String> result = new HashMap<String, String>();
        result.put(ValueSetParameters.ENTRY_NAME, "fbid_qual");
