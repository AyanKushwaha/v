...
public class CCACTypeFormatter extends Formatter implements BidDetailsFormatter {
	
	private static final CWLog LOG = CWLog.getLogger(CCACTypeFormatter.class);
	
	public static final String KEY = "ccac_qual";
	public static final String QUAL_TRANSLATION_KEY = "cc_ac_translation_formatter";
