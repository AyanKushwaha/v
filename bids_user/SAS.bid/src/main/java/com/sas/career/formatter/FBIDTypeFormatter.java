...
public class FBIDTypeFormatter extends Formatter implements BidDetailsFormatter {
	
	private static final CWLog LOG = CWLog.getLogger(FBIDTypeFormatter.class);
	
	public static final String KEY = "fbid_qual";
	public static final String QUAL_TRANSLATION_KEY = "fbid_translation_formatter";
