...
public interface SASAuthenticationConfiguration {
	...
	static final String COOKIE_NAME = "java:global/jcms/customization/sas/portal-appl-sessID-param";
	static final String ALLOW_FORM_BASED_LOGIN = "java:global/jcms/customization/sas/allow-form-based-login";
	static final String ALLOW_EMPTY_PASSWORD = "java:global/jcms/customization/sas/allow-empty-password";
