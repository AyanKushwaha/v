package com.sas.vacation.valuesets;
...
public class DisabledStartDatesParameterHandlerClass implements DataSourceValueSetParametersHandler {


    public DisabledStartDatesParameterHandlerClass() {
    }

    @Override
    public Map<String, String> getParameters(Map<String, String> requestParams) {
        Map<String, String> result = new HashMap<String, String>();
        result.put(ValueSetParameters.ENTRY_NAME, "disabledstartdates");
