...
public class PostponeVacationFormatter extends BaseFormatter implements BidDetailsFormatter, LocalizationAware {

    @Override
    public String formatDetails(Bid bid, FormatterContext formatterContext) {
        StringBuffer buff = new StringBuffer();
       
        appendNumberOfDays(buff, bid, "postpone_vacation");
