...
public class DisabledEndDatesParameterHandlerClass implements DataSourceValueSetParametersHandler {


    public DisabledEndDatesParameterHandlerClass() {
    }

    @Override
    public Map<String, String> getParameters(Map<String, String> requestParams) {
        Map<String, String> result = new HashMap<String, String>();
        result.put(ValueSetParameters.ENTRY_NAME, "disabledenddates");
